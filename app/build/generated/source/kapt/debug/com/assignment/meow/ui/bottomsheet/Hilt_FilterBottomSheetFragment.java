...
public abstract class Hilt_FilterBottomSheetFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FilterBottomSheetFragment_GeneratedInjector) this.generatedComponent()).injectFilterBottomSheetFragment(UnsafeCasts.<FilterBottomSheetFragment>unsafeCast(this));
    }
  }
