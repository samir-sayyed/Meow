...
public abstract class Hilt_CatFragment<ViewBinding extends ViewDataBinding, ViewModel extends BaseViewModel> extends BaseFragment<ViewBinding, ViewModel> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CatFragment_GeneratedInjector) this.generatedComponent()).injectCatFragment(UnsafeCasts.<CatFragment>unsafeCast(this));
    }
  }
